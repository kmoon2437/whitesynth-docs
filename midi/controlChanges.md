...
기본값 64는 특별히 잘려 나가는 음역이 없는 상태이다.(추후 구현할 때 자세히 기록)
...
기본값 64는 악기 자체의 기본적인 Sustain level이다. (악기 샘플 자체를 가지고 Sustain을 컨트롤한다면 이 CC가 안 먹히니 주의!)
...
### High-pass filter(HPF) cutoff - `CC#81`
